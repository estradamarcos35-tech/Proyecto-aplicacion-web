...
- Jupyter Notebook
- Git / GitHub
- Streamlit para crear una aplicación web y visualizar los datos disponibles ya procesados

Objetivo del proyecto: Facilitar la exploración de los modelos de autos disponibles usando visualizaciones interactivas y buscar autos que se adapten tanto al presupuesto, gusto o necesidad del usuario, pues se añadieron filtros y opciones de busqueda, tales como kilometraje, precio, año y tipo de vehículo.

Link del repositorio: https://github.com/estradamarcos35-tech/Proyecto-aplicacion-web
